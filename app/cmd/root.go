...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.gmaid.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".gmaid" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".gmaid")
	}
